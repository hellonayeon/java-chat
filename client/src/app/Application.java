...
public class Application {
    ...
    public static Map<String, ChatRoom> chatMap = new HashMap<>(); // 채팅방 목록 [key] 채팅방 이름, [value] 채팅방 객체 리스트 (채팅방 이름 중복 가능)

    public static Map<String, ChatFrame> chatFrameMap = new HashMap<>();// 채팅방 프레임 관리, 메시지 왔을 때 어떤 채팅방 레이블을 갱신해야 하는지 확인

    public static String curChatRoomId;
